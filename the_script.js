	...
	*/
	...
	var groupMember = { // group and member's names can be partial
		...
		'groupName1': ['*'],
		 ...
		 // use name or number to censor individuals
		'groupName2': ['person', '1234']

		// groupNames are samples, change them to (partially) match any group you want to censor.
	...
	if(censorImg) {
		...
		censorImg = function(el) {
			el.querySelector('.image-thumb img').style.webkitFilter = 'blur(' + blurValue + 'px)';
		};
	}
